...
/**
 * Декоратор для добавления специальных поверхностей в лабиринт.
 * Случайным образом заменяет обычные пути на специальные поверхности.
 */
public class SurfaceDecorator {
    ...
    /**
     * Добавляет случайные поверхности в лабиринт.
     * Заменяет некоторые обычные пути (PATH) на специальные поверхности.
     *
